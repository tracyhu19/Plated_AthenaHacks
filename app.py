...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///app7.db'  # SQLite database
db = SQLAlchemy(app)
...
def locate(): 
    ...
    return render_template('locate.html', users = users)
...
def submit_form():
    ...
    return redirect(f'locate.html')  # Redirect to another page after submission
